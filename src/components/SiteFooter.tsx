    ...
    <footer className="mt-24 border-t border-white/10 bg-black/40">
      <div className="max-w-6xl mx-auto px-6 py-12 grid gap-10 md:grid-cols-4">
        <div className="space-y-3">
          <div className="text-lg font-semibold text-white">Nexe Technologies</div>
        ...
        <div className="space-y-2 text-sm text-slate-300">
          ...
          <Link href="/innovation" className="block hover:text-white">
            Innovation
          </Link>
          <a
        ...
        <div className="space-y-2 text-sm text-slate-300">
          ...
          <Link href="/nexe" className="block hover:text-white">
            Nexe
          </Link>
          <a
