...
export const setup_account = [
  ...
  "🔒 Once logged in, you are prompted to complete your profile using a simple form. 📝 This step is vital for the functioning of Nexe's core features. 🛠️ The form includes fields for a username, private ID, contact number, and an optional bio. 🆔 The username is displayed publicly, the private ID allows others to send you secure guest messages, and the contact number is used for verification or in-app communication. 📞 The intuitive design makes it easy to fill out, with hints provided for each field. 💡 Completing this ensures your account is personalized and ready for interaction on Nexe.",
...
export const send_guest = [
  ...
  "📤 Once you press the 'Send' button, the guest message starts uploading. ⬆️ This image reflects the message-sending process in real-time. ⏰ The app uploads both the message text and media files to the server, and you’re advised not to close the tab during this process. 🚫 A subtle loader or transition indicates that your message is being processed and securely routed to the intended recipient through Nexe’s backend. 🏃‍♂️",
...
export const room_messages = [
  ...
  // Image 4
  "Here, the user has tapped the plus button after completing the Room message form. ➕ The message is now being uploaded to the Room. 🏃‍♂️ During this time, Nexe processes the text and media, ensuring proper formatting and secure storage. 🔐 This step bridges real-time content creation with long-term data accessibility. 📡 Once uploaded, the message becomes visible to all users with access to the same Private ID and Room permissions 🔑.",

  // Image 5
  "This screen shows the final result: the newly added message is now part of the Room and visible in the Room tab. 🎉 Users can scroll through all messages added to the Room, including text, images, videos, or documents. 📖🖼️🎥 Each message is displayed in chronological order, making it easy to retrieve specific entries based on time or content. 🕒 This feature is ideal for students saving important lab results or collaborative teams preserving shared updates 💡.",

  // Image 6
  "Now transitioning to the web interface, this image highlights the Nexe website's Room tab. 💻 From here, users can either send messages into the Room, access previously stored Room messages, or view public guest messages. 🌍 This tab serves as a central hub for interacting with Room content from desktop browsers. 🖥️ It's especially useful for students or team members working from a lab, classroom, or shared computer—enabling interaction with the same Room used on the mobile app 🏫.",
  ...
  // Image 8
  "Here, the form fields are filled in. ✍️ The user has entered their Username, Private ID, and Phone Number. 📱 This step validates that the person requesting Room access has appropriate credentials, helping maintain data integrity and security. 🛡️ Users should ensure their input is correct, as mismatches may result in failed access or empty data retrieval 🚫.",

  // Image 9
  "In this final image, the user has submitted the access form and successfully fetched the Room messages from the Nexe backend. ✅ The messages stored in the Room from the mobile app are now fully visible on the web platform. 🌐 This seamless sync between app and web ensures continuity of information—ideal for accessing messages from lab devices, classrooms, or personal computers without logging in. 🔄 It allows Nexe to act as a bridge between mobile-first data creation and desktop-based collaboration or storage 🏗️."
]
...
export const public_message = [
  ...
  // Image 2
  "When you tap on the three vertical dots (More button) on any Room message, a menu appears with multiple options: Delete Message, Add to Room, Forward Message, and Toggle Public/Private. ⚙️ The fourth option lets you switch the visibility mode of the selected message. 🔄 This is particularly useful if you want to make a message publicly accessible after it has already been stored in the Room. 🗂️ The toggle helps manage privacy control directly from the app UI 🛠️.",

  // Image 3
  "By default, all Room messages are private. 🔐 If you choose to toggle a message to public, a confirmation popup appears. ⚠️ This alert ensures that users don't accidentally expose sensitive messages. 🚫 It clearly warns that the message will become accessible to anyone with the Public ID. 👥 Once confirmed, the message becomes part of the publicly visible collection, allowing easier sharing and open access from the web interface 🌐.",
  ...
  // Image 5
  "To allow others to access your public messages via the Nexe website, you must set a Public ID in your profile. 👤 If you haven't done so already, go to the Profile tab in the Nexe app. 📲 Here, you will see your Public ID field along with an edit button next to it. ✏️ This step is essential for connecting your mobile messages to their web-accessible version 🌍.",
  ...
  // Image 9
  "To access public messages from the web, go to the Nexe website and look for the Room tab. 🖥️ There, you'll see an earth icon, which signifies access to public messages. 🌍 This entry point is specifically designed for viewing messages that were shared via Public ID from the mobile app. 📲 It's a quick and login-free way for others to view your publicly shared information 👀.",
...
export const innovationShowcase = [
  {
    name: "Nexe",
    tagline: "Anonymous secure sharing product",
    problem:
      "Secure file exchange often requires account creation and identity exposure, which fails in shared or high-risk environments.",
    marketGap:
      "Institutions need a login-free, encrypted sharing flow that still preserves control and auditability.",
    architecture:
      "Client-side encryption, ID-based routing, and compartmentalized storage buckets with ephemeral expiry policies.",
    techStack: ["Next.js", "TailwindCSS", "Appwrite", "Edge Storage", "CryptoJS"],
    securityModel:
      "Zero-knowledge payload handling with rotating keys and strict access boundaries per private ID.",
    businessVision:
      "Freemium for individuals with paid institutional deployments and compliance add-ons.",
    roadmap:
      "Offline-first sharing, managed retention policies, and hardware-backed key custody.",
  },
  {
    name: "NexConnect",
    tagline: "Anonymous communication platform",
    problem:
      "High-stakes teams need encrypted collaboration without metadata leakage or retention risks of consumer chat tools.",
    marketGap:
      "Regulated teams require policy-first communications with access governance and audit trails.",
    architecture:
      "Zero-trust session boundaries, role-based access, and compartmentalized channel storage with rotating keys.",
    techStack: [
      "Next.js",
      "TailwindCSS",
      "Framer Motion",
    ...
    securityModel:
      "Encrypted messaging with continuous verification, device attestation, and scoped session revocation.",
    businessVision:
      "Enterprise licensing with tiered compliance packages and dedicated support.",
    roadmap:
      "Confidential voice sessions, compliance-grade exports, and federation across organizations.",
  },
  {
    name: "Signal Relay",
    tagline: "Privacy-first routing layer",
    problem:
      "Product teams need a secure way to route sensitive payloads across multiple services without data duplication.",
    marketGap:
      "Most routing layers are optimized for throughput, not privacy guarantees or observability.",
    architecture:
      "Privacy-aware broker with metadata stripping, encryption envelopes, and per-tenant isolation.",
    techStack: ["Edge Workers", "Policy Engine", "Secure Queues", "Telemetry"],
    securityModel:
      "Policy-driven encryption boundaries with enforced tenant isolation and audit trails.",
    businessVision:
      "Infrastructure subscription with usage-based pricing and enterprise SLAs.",
    roadmap: "Composable privacy middleware for third-party product teams.",
  },
];
